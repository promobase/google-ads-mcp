...
from src.sdk_services.shared.shared_set_service import register_shared_set_tools

# Create the shared set server
shared_set_sdk_server = FastMCP(
    name="shared_set",
...
shared_set_service = register_shared_set_tools(shared_set_sdk_server)
