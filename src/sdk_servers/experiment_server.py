...
from src.sdk_services.campaign.experiment_service import register_experiment_tools

# Create the experiment server
experiment_sdk_server = FastMCP(
    name="experiment",
...
experiment_service = register_experiment_tools(experiment_sdk_server)
